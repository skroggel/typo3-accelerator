 ...
 * @api
 * @deprecated If possible please switch to MarkerReducerAdvanced. This class will no longer be maintained.
 */
final class MarkerReducerLegacy implements MarkerReducerInterface
{
